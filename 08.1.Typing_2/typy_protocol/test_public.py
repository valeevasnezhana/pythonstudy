...
def check_func(module, test_case, is_success):
    import uuid
    import pathlib
    temp_root_dir = "C:\\Users\\valee\\Documents\\PythonStudy\\public-2021-fall-master\\public-2021-fall-master\\data"
    # with tempfile.NamedTemporaryFile(mode="w") as fp:
    with open(f"{temp_root_dir}/{uuid.uuid4()}.py", mode="w") as fp:
