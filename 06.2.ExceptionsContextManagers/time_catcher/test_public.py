...
def test_params(soft_timeout: Optional[float], hard_timeout: Optional[float], correct: bool) -> None:
    if correct:
...
def test_timeout(
        sleep_time: float, soft_timeout: Optional[float], hard_timeout: float, exception: type[TimeoutException]
) -> None:
